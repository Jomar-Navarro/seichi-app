	...
	return (
		<div className="min-h-lvh flex flex-col items-center justify-center px-7">
			<div className="w-full max-w-sm xl:max-w-lg 2xl:max-w-xl text-center">
				<div className="w-14 h-14 2xl:w-20 2xl:h-20 flex items-center justify-center rounded-2xl 2xl:rounded-3xl bg-surface border border-glass-border mx-auto mb-6">
